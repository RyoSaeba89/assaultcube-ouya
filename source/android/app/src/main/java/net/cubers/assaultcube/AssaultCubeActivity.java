...
public class AssaultCubeActivity extends SDLActivity {
    ...
    protected String[] getLibraries() {
        // OUYA = Android API 16: the legacy dynamic linker does NOT resolve transitive
        // DT_NEEDED dependencies from the app's private lib dir. We must therefore preload
        // every native library explicitly, in dependency order (deepest dependency first).
        // The last entry MUST be "main" (SDL uses it as the main shared object).
        return new String[] {
                "c++_shared",
                "hidapi",
                "ogg",
