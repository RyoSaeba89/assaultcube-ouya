...
VARP(touchcontrols, 0, 0, 1); // OUYA: on-screen gameplay touch controls (stick/look/fire/jump/etc.) - hidden by default since the gamepad is used; the menu button stays visible
